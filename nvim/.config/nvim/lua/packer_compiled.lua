...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FixCursorHold.nvim', 'nvim-treesitter', 'Comment.nvim', 'nvim-cmp', 'nvim-lsp-installer', 'gitsigns.nvim', 'nvim-colorizer.lua', 'nvim-lspconfig', 'null-ls.nvim', 'lspsaga.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
