...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lsp-installer', 'FixCursorHold.nvim', 'Comment.nvim', 'nvim-colorizer.lua', 'gitsigns.nvim', 'nvim-cmp', 'null-ls.nvim', 'lspsaga.nvim', 'nvim-lspconfig', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
