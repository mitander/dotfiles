...
lspconfig.sumneko_lua.setup(require("plugins.lsp.server-settings/sumneko_lua"))
lspconfig.rust_analyzer.setup(require("plugins.lsp.server-settings/rust_analyzer"))
