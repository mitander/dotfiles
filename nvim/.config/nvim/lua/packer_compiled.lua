...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'Comment.nvim', 'nvim-lspconfig', 'lspsaga.nvim', 'nvim-treesitter', 'FixCursorHold.nvim', 'null-ls.nvim', 'nvim-cmp', 'gitsigns.nvim', 'nvim-lsp-installer', 'nvim-colorizer.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
