...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-colorizer.lua', 'nvim-lspconfig', 'nvim-treesitter', 'nvim-cmp', 'FixCursorHold.nvim', 'Comment.nvim', 'null-ls.nvim', 'nvim-lsp-installer', 'lspsaga.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
