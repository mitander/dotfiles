...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'FixCursorHold.nvim', 'Comment.nvim', 'nvim-lspconfig', 'nvim-cmp', 'null-ls.nvim', 'lspsaga.nvim', 'nvim-lsp-installer', 'nvim-colorizer.lua', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
