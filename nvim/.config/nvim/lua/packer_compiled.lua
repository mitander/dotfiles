...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FixCursorHold.nvim', 'Comment.nvim', 'nvim-colorizer.lua', 'null-ls.nvim', 'lspsaga.nvim', 'nvim-treesitter', 'gitsigns.nvim', 'nvim-lsp-installer', 'nvim-lspconfig', 'nvim-cmp'}, { event = "BufRead *" }, _G.packer_plugins)]]
