...
M.colors = {
    ...
    syntax_attribute = "#569fba",
    syntax_boolean = "#eb98c3",
    syntax_comment = "#6e6a86",
    syntax_doc_comment = "#908caa",
    syntax_constant = "#f6c177",
    syntax_function = "#569fba",
    syntax_type = "#9ccfd8",
    syntax_keyword = "#c4a7e7",
    syntax_primary = "#e0def4",
    syntax_property = "#eb6f92",
    syntax_punctuation = "#e0def4",
...
function M.setup()
    ...
    hi("@punctuation.bracket", { fg = c.syntax_punctuation })
    hi("@punctuation.delimiter", { fg = c.syntax_punctuation })
    hi("@punctuation.special", { fg = c.syntax_special })
    hi("@string", { fg = c.syntax_string })
